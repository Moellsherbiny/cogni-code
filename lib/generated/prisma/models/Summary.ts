...
export type SummaryWhereInput = {
  ...
  mindMap?: Prisma.JsonFilter<"Summary">
}
...
export type SummaryScalarWhereWithAggregatesInput = {
  ...
  mindMap?: Prisma.JsonWithAggregatesFilter<"Summary">
}
...
export type SummaryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "createdAt" | "content" | "summary" | "mindMap", ExtArgs["result"]["summary"]>
...
export interface SummaryFieldRefs {
  ...
  readonly mindMap: Prisma.FieldRef<"Summary", 'Json'>
}
